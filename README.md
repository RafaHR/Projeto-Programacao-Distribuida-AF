...
Dentro desse contexto, os processos que serão convertidos para utilizar vetorização são a aplicação do XOR entre a matriz preenchida com os números aleatórios gerados pelo QRNG e a imagem original e a ordenação dos pixels por meio do mapa logístico caótico.
